...
exports.saveSendEmails = async (request, response) => {
    try {
...
exports.toggleStarredEmail = async (request, response) => {
    try {   
...
exports.deleteEmails = async (request, response) => {
    try {
...
exports.moveEmailsToBin = async (request, response) => {
    try {
